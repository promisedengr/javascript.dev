...
const init = (params) => {
    ...
    header.className = "header-text intro-header-text text-center mb-3";
    header.textContent = "Software Engineer";

    let subheader = document.createElement('p');
    subheader.className = "body-text intro-body-text mb-1";
    subheader.textContent = "This is a software engineer with 6 years of experience.";

    let list1 = document.createElement('li');
    list1.className = "body-text intro-body-text mb-1";
    list1.textContent = "Full experience with PostgreSql, Mysql, Mongodb, Firebase.";

    let list2 = document.createElement('li');
    list2.className = "body-text intro-body-text mb-1";
    list2.textContent = "Very experienced backend developer who has lived with Node.js/Express(Jade,Ejs)/Socket.io, Python, Discord.js, Google+Discord+Steam+Telegram oAuth, PHP/CMS/Laravel, Postgresql/Mysql/Mongodb/Redius/Typeform/Firebase";
    ...
    webaImageContainer.appendChild(content);
 ...
 */
    ...
    // disable cyclecontainer for genesis
